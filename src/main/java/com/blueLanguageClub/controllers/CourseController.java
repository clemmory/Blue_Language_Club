...
public class CourseController {
    ...
    public ResponseEntity<Map<String, Object>> deleteCourseById(
        ...
        try {
            ...
            if (course != null) {
                if (course.getDate().isBefore(today)
                        || course.getDate().isEqual(today) && course.getTime().isBefore(now)) {
    ...
    // Courses disponibles pour dates futute/prochaine
    ...
    public ResponseEntity<Map<String, Object>>getAvailableCoursesForFutureDates() {
        ...
        try {
            ...
            List<Course> availableCourses = existingCourses.stream()
                    .filter(course -> course.getDate().isAfter(currentDate) ||
                            (course.getDate().isEqual(currentDate) && course.getTime()
                            .isAfter(currentTime)))
